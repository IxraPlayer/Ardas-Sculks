...
public class SculkPlanksPickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(SculksOfArdaModBlocks.SCULK_LOG_PLANKS.get()));
		}
	};

	public SculkPlanksPickaxeItem() {
