...
import sculk.of.ixra.procedures.SculkPowerOnEffectActiveTickProcedure;
...
public class SculkArmsItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.sculks_of_arda.sculk_arms.description_0"));
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			SculkPowerOnEffectActiveTickProcedure.execute(entity);
	}
}
