...
import sculk.of.ixra.procedures.GoldenSculkArmsEffectProcedure;
...
public class GoldenSculkArmsItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.sculks_of_arda.golden_sculk_arms.description_0"));
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			GoldenSculkArmsEffectProcedure.execute(entity);
	}
}
