...
public class RadioactiveBalsaForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<RadioactiveBalsaForestFruitDecorator> CODEC = MapCodec.unit(RadioactiveBalsaForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:radioactive_balsa_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public RadioactiveBalsaForestFruitDecorator() {
		super(0.2f);
	}
