...
public class BlackBirchForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<BlackBirchForestLeaveDecorator> CODEC = MapCodec.unit(BlackBirchForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:black_birch_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public BlackBirchForestLeaveDecorator() {
		super(0.25f);
	}
