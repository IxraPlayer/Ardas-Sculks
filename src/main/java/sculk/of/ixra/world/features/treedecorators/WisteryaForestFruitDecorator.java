...
public class WisteryaForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<WisteryaForestFruitDecorator> CODEC = MapCodec.unit(WisteryaForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:wisterya_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public WisteryaForestFruitDecorator() {
		super(0.2f);
	}
