...
public class SculkDesertsFruitDecorator extends CocoaDecorator {
	public static MapCodec<SculkDesertsFruitDecorator> CODEC = MapCodec.unit(SculkDesertsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_deserts_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public SculkDesertsFruitDecorator() {
		super(0.2f);
	}
