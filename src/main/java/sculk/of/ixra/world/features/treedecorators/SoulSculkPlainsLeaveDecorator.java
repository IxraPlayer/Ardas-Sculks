...
public class SoulSculkPlainsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SoulSculkPlainsLeaveDecorator> CODEC = MapCodec.unit(SoulSculkPlainsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:soul_sculk_plains_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SoulSculkPlainsLeaveDecorator() {
		super(0.25f);
	}
