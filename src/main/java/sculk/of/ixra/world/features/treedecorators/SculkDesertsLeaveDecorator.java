...
public class SculkDesertsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SculkDesertsLeaveDecorator> CODEC = MapCodec.unit(SculkDesertsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_deserts_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SculkDesertsLeaveDecorator() {
		super(0.25f);
	}
