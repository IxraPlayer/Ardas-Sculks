...
public class SculkWoodsTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<SculkWoodsTrunkDecorator> CODEC = MapCodec.unit(SculkWoodsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_woods_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
