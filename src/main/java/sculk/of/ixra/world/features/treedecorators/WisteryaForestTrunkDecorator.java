...
public class WisteryaForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<WisteryaForestTrunkDecorator> CODEC = MapCodec.unit(WisteryaForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:wisterya_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
