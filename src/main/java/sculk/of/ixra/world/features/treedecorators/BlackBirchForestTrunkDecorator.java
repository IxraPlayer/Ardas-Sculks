...
public class BlackBirchForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<BlackBirchForestTrunkDecorator> CODEC = MapCodec.unit(BlackBirchForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:black_birch_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
