...
public class SoulSculkPlainsFruitDecorator extends CocoaDecorator {
	public static MapCodec<SoulSculkPlainsFruitDecorator> CODEC = MapCodec.unit(SoulSculkPlainsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:soul_sculk_plains_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public SoulSculkPlainsFruitDecorator() {
		super(0.2f);
	}
