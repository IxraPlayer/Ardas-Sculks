...
public class SculkWoodsFruitDecorator extends CocoaDecorator {
	public static MapCodec<SculkWoodsFruitDecorator> CODEC = MapCodec.unit(SculkWoodsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_woods_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public SculkWoodsFruitDecorator() {
		super(0.2f);
	}
