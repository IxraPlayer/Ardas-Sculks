...
public class SculkPlainsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SculkPlainsLeaveDecorator> CODEC = MapCodec.unit(SculkPlainsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_plains_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SculkPlainsLeaveDecorator() {
		super(0.25f);
	}
