...
package sculk.of.ixra.world.features.treedecorators;
...
public class RadioactiveBalsaForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<RadioactiveBalsaForestLeaveDecorator> CODEC = MapCodec.unit(RadioactiveBalsaForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:radioactive_balsa_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RadioactiveBalsaForestLeaveDecorator() {
		super(0.25f);
	}
