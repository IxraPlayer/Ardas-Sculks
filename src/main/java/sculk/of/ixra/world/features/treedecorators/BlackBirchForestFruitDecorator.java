...
public class BlackBirchForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<BlackBirchForestFruitDecorator> CODEC = MapCodec.unit(BlackBirchForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:black_birch_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public BlackBirchForestFruitDecorator() {
		super(0.2f);
	}
