...
public class MushroomSculkForestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<MushroomSculkForestTrunkDecorator> CODEC = MapCodec.unit(MushroomSculkForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:mushroom_sculk_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
