...
public class WisteryaForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<WisteryaForestLeaveDecorator> CODEC = MapCodec.unit(WisteryaForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:wisterya_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public WisteryaForestLeaveDecorator() {
		super(0.25f);
	}
