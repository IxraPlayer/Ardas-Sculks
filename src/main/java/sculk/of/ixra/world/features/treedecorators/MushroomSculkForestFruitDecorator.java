...
public class MushroomSculkForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<MushroomSculkForestFruitDecorator> CODEC = MapCodec.unit(MushroomSculkForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:mushroom_sculk_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public MushroomSculkForestFruitDecorator() {
		super(0.2f);
	}
