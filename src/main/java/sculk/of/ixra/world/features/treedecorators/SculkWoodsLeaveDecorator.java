...
public class SculkWoodsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SculkWoodsLeaveDecorator> CODEC = MapCodec.unit(SculkWoodsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("sculks_of_arda:sculk_woods_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SculkWoodsLeaveDecorator() {
		super(0.25f);
	}
