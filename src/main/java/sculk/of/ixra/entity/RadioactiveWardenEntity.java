...
import sculk.of.ixra.procedures.RadioactiveWardenOnEntityTickUpdateProcedure;
...
public class RadioactiveWardenEntity extends Zombie implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RadioactiveWardenEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RadioactiveWardenEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RadioactiveWardenEntity.class, EntityDataSerializers.STRING);
	...
	public RadioactiveWardenEntity(EntityType<RadioactiveWardenEntity> type, Level world) {
		super(type, world);
		xpReward = 700;
		setNoAi(false);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "radioactivewarden");
	}
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(SculksOfArdaModItems.RADIOACTIVE_SCULK_ARM.get()));
	}
	...
	public void baseTick() {
		super.baseTick();
		RadioactiveWardenOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 920);
		builder = builder.add(Attributes.ARMOR, 8.8);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 25) {
			this.remove(RadioactiveWardenEntity.RemovalReason.KILLED);
