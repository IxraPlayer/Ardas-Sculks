...
public class SculksOfArdaMod {
	...
	public SculksOfArdaMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		SculksOfArdaModBlocks.REGISTRY.register(modEventBus);
		SculksOfArdaModBlockEntities.REGISTRY.register(modEventBus);
		SculksOfArdaModItems.REGISTRY.register(modEventBus);
		SculksOfArdaModEntities.REGISTRY.register(modEventBus);
		SculksOfArdaModTabs.REGISTRY.register(modEventBus);

		SculksOfArdaModMobEffects.REGISTRY.register(modEventBus);
		SculksOfArdaModMenus.REGISTRY.register(modEventBus);
		SculksOfArdaModParticleTypes.REGISTRY.register(modEventBus);
		SculksOfArdaModVillagerProfessions.PROFESSIONS.register(modEventBus);
